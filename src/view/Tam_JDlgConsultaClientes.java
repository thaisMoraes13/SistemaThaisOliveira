 ...
 * @author Marcos
 */
public class Tam_JDlgConsultaClientes extends javax.swing.JDialog {

    Tam_ControllerConsultasClientes controllerConsultasProdutos;
    ClientesDAO produtosDAOdutos;

    public Tam_JDlgConsultaClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pesquisar Clientes");
        controllerConsultasProdutos = new Tam_ControllerConsultasClientes();
        produtosDAOdutos = new ClientesDAO();
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        if (jTxtNome.getText().isEmpty() == false && jTxtValor.getText().isEmpty() == false) {
            ...
            List lista = (List) produtosDAOdutos.listNomeNumero(jTxtNome.getText(), jTxtValor.getText());
            controllerConsultasProdutos.setList(lista);

        } else if (jTxtValor.getText().isEmpty() == false) {
            List lista = (List) produtosDAOdutos.listNumero(jTxtValor.getText());
            controllerConsultasProdutos.setList(lista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tam_JDlgConsultaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tam_JDlgConsultaClientes dialog = new Tam_JDlgConsultaClientes(new javax.swing.JFrame(), true);
